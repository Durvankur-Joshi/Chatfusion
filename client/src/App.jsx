...
// function App() {
//   const { userInfo, setUserInfo, logout } = useAppStore(); // Added `logout` function
//   const [loading, setLoading] = useState(true);
...
//   // Logout button inside the Chat page or Profile page (depending on your preference)
//   const handleLogout = () => {
//     logout(); // Clears the userInfo from the store
//     window.location.href = '/auth'; // Redirect to the login/signup page
//   };
...
//         <Route 
//           path='/chat' 
//           element={<PrivateRoute><Chat onLogout={handleLogout} /></PrivateRoute>} 
//         />
//         <Route 
//           path='/profile' 
//           element={<PrivateRoute><Profile onLogout={handleLogout} /></PrivateRoute>} 
//         />
//         <Route path='*' element={<Navigate to="/auth" />} />
//       </Routes>
//     </BrowserRouter>
